        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="banner-ad bg-danger mb-3"
                    style="background: url({{ url('assets/frontend/images/ad-image-3.png') }});background-repeat: no-repeat;background-position: right bottom;">
            ...
            <div class="col-md-6">
                <div class="banner-ad bg-info"
                    style="background: url({{ url('assets/frontend/images/ad-image-4.png') }});background-repeat: no-repeat;background-position: right bottom;">
                    <div class="banner-content p-5">
...
<section class="py-5">
    <div class="container-fluid">
        ...
        <div class="bg-secondary py-5 my-5 rounded-5"
            style="background: url({{ url('assets/frontend/images/bg-leaves-img-pattern.png') }}) no-repeat;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <img src="{{ url('assets/frontend/images/app-store.jpg') }}" alt="app-store">
                            <img src="{{ url('assets/frontend/images/google-play.jpg') }}" alt="google-play">
                        </div>
                    </div>
                </div>
            </div>
